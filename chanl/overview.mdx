...
- Fetch simulation results for automated quality checks
- Monitor production agents and get alerts via webhooks

```javascript
// Example: Automated testing in your pipeline
const chanl = require('@chanl/sdk');

await chanl.scenarios.create({
  name: 'PR #123 - New refund flow',
