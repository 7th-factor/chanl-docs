...
The API is organized into six main sections:

<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/api-reference/auth/exchange">
    JWT tokens, API keys, and workspace switching
  </Card>
  <Card title="Workspaces" icon="building" href="/api-reference/workspaces/list">
    Multi-tenant workspace management and settings
  </Card>
...
### JWT Bearer Tokens
For user authentication via Firebase integration:
